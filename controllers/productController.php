...
//Update
if (isset($_GET["edit"])) {
    if (isset($_POST['name']) && isset($_POST['description']) && isset($_POST['price']) && isset($_POST['stock']) && isset($_POST["idCategoria"])) {
        $id = $_GET['id'];
        $name = $_POST['name'];
        ...
        ProductRepository::updateProduct($id, $name, $description, $price, $stock, $productImagePath, $idCategory);
        header("Location: index.php?c=product&id=" . $id);
        exit();
    }
